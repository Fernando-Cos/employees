            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Funcionários</a>
                        <a class="collapse-item" href="cards.html">Terceizados</a>
             ...
             <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo1"
                    ...
                    <i class="fas fa-fw fa-cog"></i>
                    <span style="color: red">Em teste</span>
                </a>
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar1">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Todos os direitos reservados 2021<br><br><b>Tecno$Cia</b></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
